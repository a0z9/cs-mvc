...
namespace WebApp8_cookiee.Utils
{
    public static class CustomHtmlHelper
    {
        ...
        public static HtmlString RolesHelper(this IHtmlHelper htmlHelper, IEnumerable<Role> roles)
        {
            ...
            foreach (Role role in Resources.Roles) result.Append($"<li>{role.Name}</li>");
            result.Append("</ol>");
        ...
        public static HtmlString RoleSelector(this IHtmlHelper htmlHelper, IEnumerable<Role> roles)
        {
            ...
            foreach (Role role in Resources.Roles) result.Append($"<option value='{role.Id}'>{role.Name}</option>");
